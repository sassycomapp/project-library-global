...
10. **Table and field names match `authoritative-schema.md` (mb-3-cs project library)** — `business_profile` (with underscore) **[[adr-onboarding-data-schema-alignment|Onboarding Data Schema Alignment]]**
...
> **Note:** All table and field names match `authoritative-schema.md` (mb-3-cs project library). `business_profile` (with underscore) is used throughout. **[[adr-onboarding-data-schema-alignment|Onboarding Data Schema Alignment]]**
