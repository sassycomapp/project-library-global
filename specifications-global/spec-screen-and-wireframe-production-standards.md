...
Before producing any screen, the agent must read the following documents in full. This is a
quality gate — the second this list drifts from reality, screen production quality degrades.

**Fixed reading order:**

1. This document (`spec-screen-and-wireframe-production-standards.md`)
...
11. Package-specific architecture documents for the form being produced

**Rule:** The list is versioned. Any document added to or removed from this list must be
reflected here. The agent reads the list, then reads the documents — in order, in full,
before any screen HTML is generated.*
