...
[More about Anvil X pricing](../../../x/pricing)
...
## [Managing your viewers](#managing-your-viewers)
...
If you are a manager of your Anvil subscription, and open the Anvil X configuration tab, you will see the current list of viewers. If a viewer has signed in with the [Users Service](../../users), then you can see email address that identifies them. You can remove viewers from the list to free up slots for other users.
...
## [Purchasing new viewers](#purchasing-new-viewers)

If you pay for your Anvil subscription by card, you can add extra Tableau viewers to your Anvil subscription from [anvil.works/manage](../../../manage) or from the **My Account** dialog. If you pay by invoice, contact [sales@anvil.works](mailto:sales@anvil.works).
