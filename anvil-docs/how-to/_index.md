...
These how-to guides cover multiple topics. If you’re looking for guides relevant to one topic or component in Anvil, please refer to the relevant section of the [reference docs](/docs).
...
### Collaborate as a team in Anvil

Set up a secure workflow for managing development and production environments using GitHub

### Serve your UI from HTTP routes

Serve your app's user interface from HTTP endpoints using AppResponder.

### Prompting the Anvil AI agent

Best practices on how to prompt the Anvil AI agent
...
Learn how to upload large files directly to Amazon s3 or a similar service.

### Port an app to new Layouts

Anvil has introduced Layouts, a major update to the Anvil UI system. Here's how to port an app over to the new Layouts system.
