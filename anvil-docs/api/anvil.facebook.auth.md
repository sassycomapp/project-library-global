...
[`get_user_access_token`](#get_user_access_token) [`get_user_email`](#get_user_email) [`get_user_id`](#get_user_id) [`login`](#login)

## Functions

#### `get_user_access_token()` [(more info)](/docs/integrations/facebook)
