...
## [Save an app as a GitHub repo](#save-an-app-as-a-github-repo)
...
Open the [Version History tab](/docs/version-control) in the Bottom Panel and click the “Save app to GitHub” button.
...
## [Checkout an app from GitHub](#checkout-an-app-from-github)
...
Read more about [Connecting to GitHub and Other Git Remotes](/docs/version-control/git).
