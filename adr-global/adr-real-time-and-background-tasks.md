...
| `integration-architecture.md` (mb-3-cs project library) | Section 4: Background Tasks (existing task inventory) |
| `deployment-procedures.md` (mb-3-cs project library) | Operational procedures for task failure recovery |
