...
- ✅ UI and form updates propagate automatically via master_template dependency (confirmed by Test B — see [[adr-client-instance-architecture|Client Instance Architecture]] ADR)
