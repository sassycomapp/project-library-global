...
- This session's own direct read of the Connection table in `spec-postgres-ledger.md` (makePDLF project library), confirming `.env`-based credential storage as the current, real pattern
